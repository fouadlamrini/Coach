            ...
            <div className="grid lg:grid-cols-12 gap-16 items-center relative z-10">
                ...
                <div className="lg:col-span-6 space-y-8 text-left">
                    ...
                    <div className="pt-4 flex flex-col sm:flex-row gap-4">
                        <a href="#" className="shadow-[0_0_25px_rgba(205,178,109,0.25)] bg-gradient-to-r from-[#F3DA90] via-[#CDB26D] to-[#967531] text-[#030712] px-8 py-4 rounded-xl font-bold tracking-wide uppercase text-xs text-center transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-[0_0_35px_rgba(205,178,109,0.45)]">
                ...
                <div className="lg:col-span-6 group">
                    <div className="relative p-1 rounded-2xl bg-gradient-to-b from-slate-800 via-slate-900 to-[#967531]/30 shadow-2xl transition duration-500">
                        ...
                        <div className="relative bg-[#070a0f] rounded-xl overflow-hidden aspect-video border border-[#CDB26D]/30 group-hover:border-[#F3DA90]/60 transition duration-500">
